        ...
        )
{
...
#if DEBUG
    mycsout <<  __func__ << "(targetSize=" << targetSize << ")" << '\n';
#endif
    ...
    switch (type->code) {
        ...
        case 0x000b: // unicode_string
            ...
            memcpy(target, str.str().c_str(), dataSize);
        ...
        case 0x001a: // uint56
            {
                ...
                g_err << "Non-native integer type " << type->name
        ...
        case 0xfffe: // sm64
            {
                ...
                g_err << "Sign-and-magitude types not yet"
        ...
        default:
            {
                ...
                g_err << "Unknown data type 0x" << hex << type->code;
...
int DataTypeHandler::outputData(
        ostream &o,
        const DataType *type,
        void *data,
        size_t dataSize
        )
{
    ...
    if (type) {
        if (type->byteSize && dataSize != type->byteSize) {
            ...
            g_err << "Data type mismatch. Expected " << type->name
    ...
    switch (typeCode) {
        ...
        case 0x0008: // float
            ...
            break;
        case 0x0009: // string
            str << string((const char *) data, dataSize) << endl;
            break;
        case 0x000a: // octet_string
            str << string((const char *) data, dataSize) << flush;
            break;
        case 0x000b: // unicode_string
                     // FIXME encoding
            str << string((const char *) data, dataSize) << endl;
        ...
        )
{
    ...
    str1 << hex << setfill('0');
    while (size--) {
        str1 << "0x" << setw(2) << (unsigned int) *data++;
        if (size)
            str1 << " ";
    }
    str1 << endl;
