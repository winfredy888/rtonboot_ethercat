...
#define MMU_INITIAL_MAPPING_FLAG_DYNAMIC  8  /* entry has to be patched up by platform_reset */

#ifdef __ASSEMBLY__

#define CONFIG_IMAGE_VADDR_BASE 0xffffffbebec00000
#define RTONBOOT_MAX_SZIE  0x100000000
#define CONFIG_DEBUG_VADDR_BASE 0xffffffbebec00100
#define CONFIG_SLAVE_ENTRY_VADDR 0xffffffbebec00128

#else

#define CONFIG_IMAGE_VADDR_BASE 0xffffffbebec00000ULL
#define RTONBOOT_MAX_SZIE  0x100000000ULL
#define CONFIG_DEBUG_VADDR_BASE 0xffffffbebec00100ULL
#define CONFIG_SLAVE_ENTRY_VADDR 0xffffffbebec00128ULL
