...
#define KERNEL_ASPACE_BITS 48

#if KERNEL_ASPACE_BITS < 25
#define MMU_KERNEL_SIZE_SHIFT (25)
//#define MMU_KERNEL_SIZE_SHIFT (26)
#else
...
#define SHIFT_MINUS (MMU_KERNEL_SIZE_SHIFT - MMU_KERNEL_TOP_SHIFT)
#define MMU_KERNEL_PAGE_TABLE_ENTRIES_TOP (1 << SHIFT_MINUS)
...
#define MMU_INITIAL_MAP_DEVICE \
	...
	#define MMU_CLEAR_TOP_VADDR (~0 << MMU_KERNEL_SIZE_SHIFT)
