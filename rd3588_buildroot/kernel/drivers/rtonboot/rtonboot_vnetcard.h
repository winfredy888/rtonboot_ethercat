#ifndef _RTONBOOT_VNETCARD_DRIVER_H_
#define _RTONBOOT_VNETCARD_DRIVER_H_
...
/* Constants */
#define VIRT_NET_DRIVER_NAME "rtonboot_vnetcard_driver"
...
#define VIRT_NET_INTF_NAME "rteth"
...
#define BUFFER_STATE_LEANER 0
#define BUFFER_STATE_FRAGE 1

typedef struct rteth_send_desc
{
	int buf_state;
	uint32_t cur_total_len;
	int index;
	int cur_size;
	struct sk_buff * skb;
	char * curbuf;
...
#endif /* _RTONBOOT_VNETCARD_DRIVER_H_ */
