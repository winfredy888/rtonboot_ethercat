...
static const DECLARE_TLV_DB_SCALE(dac_tlv, -9500, 37, 1);
...
//	SOC_SINGLE_TLV("Capture MIC Volume", RK817_CODEC_DADC_VOLL,
//		     0, 255, 1, dac_tlv),

        SOC_SINGLE_TLV("Playback R Volume", RK817_CODEC_DDAC_VOLR,0, 255, 1, dac_tlv),
        SOC_SINGLE_TLV("Playback L Volume", RK817_CODEC_DDAC_VOLL,0, 255, 1, dac_tlv),
	SOC_SINGLE_TLV("MIC R GAIN", RK817_CODEC_DMIC_PGA_GAIN,0, 15, 0, dac_tlv),
        SOC_SINGLE_TLV("MIC L GAIN", RK817_CODEC_DMIC_PGA_GAIN,4, 15, 0, dac_tlv),
        SOC_SINGLE_TLV("Capture MIC_L Volume", RK817_CODEC_DADC_VOLL,0, 255, 1, dac_tlv),
        SOC_SINGLE_TLV("Capture MIC_R Volume", RK817_CODEC_DADC_VOLR,0, 255, 1, dac_tlv),
