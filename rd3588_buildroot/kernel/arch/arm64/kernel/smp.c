...
static void __init hyp_mode_check(void)
{
	...
	/*Winfred Young comment	 for rtonboot*/
...
#define S(x,s)	[x] = s
	...
	#ifdef CONFIG_RTONBOOT_SUPPORT
	S(IPI_RTONBOOT, "RTONBOOT interrupts"),
	#endif
};
...
extern int rtonboot_ipi_on_main_core(void);
...
static void do_handle_IPI(int ipinr)
{
	...
	case IPI_RTONBOOT:
		...
		(void)rtonboot_ipi_on_main_core();
