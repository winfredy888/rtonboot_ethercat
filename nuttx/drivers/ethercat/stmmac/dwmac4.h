...
#define GMAC_RXQCTRL_PSRQX_MASK(x)	MYGENMASK(7 + ((x) * 8), 0 + ((x) * 8))
#define GMAC_RXQCTRL_PSRQX_SHIFT(x)	((x) * 8)

/* TX Queues Priorities */
#define GMAC_TXQCTRL_PSTQX_MASK(x)	MYGENMASK(7 + ((x) * 8), 0 + ((x) * 8))
...
#define MTL_RXQ_DMA_QXMDMACH_MASK(x)	MYGENMASK(11 + (8 * ((x) - 1)), 8 * (x))
