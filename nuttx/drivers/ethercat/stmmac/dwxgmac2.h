...
#define XGMAC_RXQEN(x)			MYGENMASK((x) * 2 + 1, (x) * 2)
...
#define XGMAC_PSRQ(x)			MYGENMASK((x) * 8 + 7, (x) * 8)
...
#define XGMAC_QxMDMACH(x)		MYGENMASK((x) * 8 + 7, (x) * 8)
#define XGMAC_QxMDMACH_SHIFT(x)		((x) * 8)
#define XGMAC_QDDMACH			BIT(7)
#define XGMAC_TC_PRTY_MAP0		0x00001040
#define XGMAC_TC_PRTY_MAP1		0x00001044
#define XGMAC_PSTC(x)			MYGENMASK((x) * 8 + 7, (x) * 8)
