			       ...
			       struct dma_desc *p, void __iomem *ioaddr)
{
	...
	struct netdev_statistics_s * __attribute__((unused)) stats = (struct netdev_statistics_s *)data;
	...
	if (unlikely(tdes0 & TDES0_ERROR_SUMMARY)) {
		...
		if (unlikely((tdes0 & TDES0_EXCESSIVE_DEFERRAL) ||
			...
			unsigned int __attribute__((unused)) collisions;
