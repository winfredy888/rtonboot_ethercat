...
{
	u32 val = getreg32( (u64)(ioaddr + GMAC_AN_STATUS(reg)));
...
{
	u32 value = getreg32( (u64)(ioaddr + GMAC_AN_CTRL(reg)));

	if (restart)
		value |= GMAC_AN_CTRL_RAN;

	putreg32(value, (u64)(ioaddr + GMAC_AN_CTRL(reg)));
}
...
{
	u32 value = getreg32( (u64)(ioaddr + GMAC_ANE_ADV(reg)));
	...
	value = getreg32( (u64)(ioaddr + GMAC_ANE_LPA(reg)));
