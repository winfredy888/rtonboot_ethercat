...
{
	u32 value = getreg32((u64)(mmcaddr + MMC_CNTRL));

	value |= (mode & 0x3F);

	putreg32(value, (u64)(mmcaddr + MMC_CNTRL));
...
{
	putreg32(MMC_DEFAULT_MASK, (u64)(mmcaddr + MMC_RX_INTR_MASK));
	putreg32(MMC_DEFAULT_MASK, (u64)(mmcaddr + MMC_TX_INTR_MASK));
	putreg32(MMC_DEFAULT_MASK, (u64)(mmcaddr + MMC_RX_IPC_INTR_MASK));
}
...
{
	mmc->mmc_tx_octetcount_gb += getreg32((u64)(mmcaddr + MMC_TX_OCTETCOUNT_GB));
	mmc->mmc_tx_framecount_gb += getreg32((u64)(mmcaddr + MMC_TX_FRAMECOUNT_GB));
	mmc->mmc_tx_broadcastframe_g += getreg32( (u64)(mmcaddr + MMC_TX_BROADCASTFRAME_G) );
	mmc->mmc_tx_multicastframe_g += getreg32( (u64)(mmcaddr + MMC_TX_MULTICASTFRAME_G) );
	mmc->mmc_tx_64_octets_gb += getreg32((u64)(mmcaddr + MMC_TX_64_OCTETS_GB) );
	mmc->mmc_tx_65_to_127_octets_gb +=
	    getreg32((u64)(mmcaddr + MMC_TX_65_TO_127_OCTETS_GB));
	mmc->mmc_tx_128_to_255_octets_gb +=
	    getreg32( (u64)(mmcaddr + MMC_TX_128_TO_255_OCTETS_GB));
	mmc->mmc_tx_256_to_511_octets_gb +=
	    getreg32( (u64)(mmcaddr + MMC_TX_256_TO_511_OCTETS_GB) );
	mmc->mmc_tx_512_to_1023_octets_gb +=
	    getreg32( (u64)(mmcaddr + MMC_TX_512_TO_1023_OCTETS_GB) );
	mmc->mmc_tx_1024_to_max_octets_gb +=
	    getreg32( (u64)(mmcaddr + MMC_TX_1024_TO_MAX_OCTETS_GB) );
	mmc->mmc_tx_unicast_gb += getreg32( (u64)(mmcaddr + MMC_TX_UNICAST_GB) );
	mmc->mmc_tx_multicast_gb += getreg32( (u64)(mmcaddr + MMC_TX_MULTICAST_GB) );
	mmc->mmc_tx_broadcast_gb += getreg32( (u64)(mmcaddr + MMC_TX_BROADCAST_GB) );
	mmc->mmc_tx_underflow_error += getreg32( (u64)(mmcaddr + MMC_TX_UNDERFLOW_ERROR) );
	mmc->mmc_tx_singlecol_g += getreg32( (u64)(mmcaddr + MMC_TX_SINGLECOL_G) );
	mmc->mmc_tx_multicol_g += getreg32( (u64)(mmcaddr + MMC_TX_MULTICOL_G) );
	mmc->mmc_tx_deferred += getreg32( (u64)(mmcaddr + MMC_TX_DEFERRED) );
	mmc->mmc_tx_latecol += getreg32( (u64)(mmcaddr + MMC_TX_LATECOL));
	mmc->mmc_tx_exesscol += getreg32( (u64)(mmcaddr + MMC_TX_EXESSCOL) );
	mmc->mmc_tx_carrier_error += getreg32( (u64)(mmcaddr + MMC_TX_CARRIER_ERROR) );
	mmc->mmc_tx_octetcount_g += getreg32( (u64)(mmcaddr + MMC_TX_OCTETCOUNT_G) );
	mmc->mmc_tx_framecount_g += getreg32( (u64)(mmcaddr + MMC_TX_FRAMECOUNT_G) );
	mmc->mmc_tx_excessdef += getreg32( (u64)(mmcaddr + MMC_TX_EXCESSDEF) );
	mmc->mmc_tx_pause_frame += getreg32( (u64)(mmcaddr + MMC_TX_PAUSE_FRAME) );
	mmc->mmc_tx_vlan_frame_g += getreg32( (u64)(mmcaddr + MMC_TX_VLAN_FRAME_G) );

	/* MMC RX counter registers */
	mmc->mmc_rx_framecount_gb += getreg32( (u64)(mmcaddr + MMC_RX_FRAMECOUNT_GB) );
	mmc->mmc_rx_octetcount_gb += getreg32( (u64)(mmcaddr + MMC_RX_OCTETCOUNT_GB) );
	mmc->mmc_rx_octetcount_g += getreg32( (u64)(mmcaddr + MMC_RX_OCTETCOUNT_G) );
	mmc->mmc_rx_broadcastframe_g += getreg32( (u64)(mmcaddr + MMC_RX_BROADCASTFRAME_G) );
	mmc->mmc_rx_multicastframe_g += getreg32( (u64)(mmcaddr + MMC_RX_MULTICASTFRAME_G) );
	mmc->mmc_rx_crc_error += getreg32( (u64)(mmcaddr + MMC_RX_CRC_ERROR) );
	mmc->mmc_rx_align_error += getreg32( (u64)(mmcaddr + MMC_RX_ALIGN_ERROR) );
	mmc->mmc_rx_run_error += getreg32( (u64)(mmcaddr + MMC_RX_RUN_ERROR) );
	mmc->mmc_rx_jabber_error += getreg32( (u64)(mmcaddr + MMC_RX_JABBER_ERROR) );
	mmc->mmc_rx_undersize_g += getreg32( (u64)(mmcaddr + MMC_RX_UNDERSIZE_G) );
	mmc->mmc_rx_oversize_g += getreg32( (u64)(mmcaddr + MMC_RX_OVERSIZE_G) );
	mmc->mmc_rx_64_octets_gb += getreg32( (u64)(mmcaddr + MMC_RX_64_OCTETS_GB) );
	mmc->mmc_rx_65_to_127_octets_gb +=
	    getreg32((u64)(mmcaddr + MMC_RX_65_TO_127_OCTETS_GB));
	mmc->mmc_rx_128_to_255_octets_gb +=
	    getreg32((u64)(mmcaddr + MMC_RX_128_TO_255_OCTETS_GB));
	mmc->mmc_rx_256_to_511_octets_gb +=
	    getreg32((u64)(mmcaddr + MMC_RX_256_TO_511_OCTETS_GB));
	mmc->mmc_rx_512_to_1023_octets_gb +=
	    getreg32((u64)(mmcaddr + MMC_RX_512_TO_1023_OCTETS_GB));
	mmc->mmc_rx_1024_to_max_octets_gb +=
	    getreg32((u64)(mmcaddr + MMC_RX_1024_TO_MAX_OCTETS_GB));
	mmc->mmc_rx_unicast_g += getreg32( (u64)(mmcaddr + MMC_RX_UNICAST_G) );
	mmc->mmc_rx_length_error += getreg32( (u64)(mmcaddr + MMC_RX_LENGTH_ERROR) );
	mmc->mmc_rx_autofrangetype += getreg32( (u64)(mmcaddr + MMC_RX_AUTOFRANGETYPE) );
	mmc->mmc_rx_pause_frames += getreg32( (u64)(mmcaddr + MMC_RX_PAUSE_FRAMES) );
	mmc->mmc_rx_fifo_overflow += getreg32( (u64)(mmcaddr + MMC_RX_FIFO_OVERFLOW) );
	mmc->mmc_rx_vlan_frames_gb += getreg32( (u64)(mmcaddr + MMC_RX_VLAN_FRAMES_GB) );
	mmc->mmc_rx_watchdog_error += getreg32( (u64)(mmcaddr + MMC_RX_WATCHDOG_ERROR) );
	/* IPC */
	mmc->mmc_rx_ipc_intr_mask += getreg32( (u64)(mmcaddr + MMC_RX_IPC_INTR_MASK) );
	mmc->mmc_rx_ipc_intr += getreg32( (u64)(mmcaddr + MMC_RX_IPC_INTR) );
	/* IPv4 */
	mmc->mmc_rx_ipv4_gd += getreg32( (u64)(mmcaddr + MMC_RX_IPV4_GD) );
	mmc->mmc_rx_ipv4_hderr += getreg32( (u64)(mmcaddr + MMC_RX_IPV4_HDERR) );
	mmc->mmc_rx_ipv4_nopay += getreg32( (u64)(mmcaddr + MMC_RX_IPV4_NOPAY) );
	mmc->mmc_rx_ipv4_frag += getreg32( (u64)(mmcaddr + MMC_RX_IPV4_FRAG) );
	mmc->mmc_rx_ipv4_udsbl += getreg32( (u64)(mmcaddr + MMC_RX_IPV4_UDSBL) );

	mmc->mmc_rx_ipv4_gd_octets += getreg32( (u64)(mmcaddr + MMC_RX_IPV4_GD_OCTETS) );
	mmc->mmc_rx_ipv4_hderr_octets +=
	    getreg32( (u64)(mmcaddr + MMC_RX_IPV4_HDERR_OCTETS) );
	mmc->mmc_rx_ipv4_nopay_octets +=
	    getreg32( (u64)(mmcaddr + MMC_RX_IPV4_NOPAY_OCTETS) );
	mmc->mmc_rx_ipv4_frag_octets += getreg32( (u64)(mmcaddr + MMC_RX_IPV4_FRAG_OCTETS) );
	mmc->mmc_rx_ipv4_udsbl_octets +=
	    getreg32( (u64)(mmcaddr + MMC_RX_IPV4_UDSBL_OCTETS) );

	/* IPV6 */
	mmc->mmc_rx_ipv6_gd_octets += getreg32( (u64)(mmcaddr + MMC_RX_IPV6_GD_OCTETS) );
	mmc->mmc_rx_ipv6_hderr_octets +=
	    getreg32( (u64)(mmcaddr + MMC_RX_IPV6_HDERR_OCTETS) );
	mmc->mmc_rx_ipv6_nopay_octets +=
	    getreg32( (u64)(mmcaddr + MMC_RX_IPV6_NOPAY_OCTETS) );

	mmc->mmc_rx_ipv6_gd += getreg32( (u64)(mmcaddr + MMC_RX_IPV6_GD) );
	mmc->mmc_rx_ipv6_hderr += getreg32( (u64)(mmcaddr + MMC_RX_IPV6_HDERR) );
	mmc->mmc_rx_ipv6_nopay += getreg32( (u64)(mmcaddr + MMC_RX_IPV6_NOPAY) );

	/* Protocols */
	mmc->mmc_rx_udp_gd += getreg32( (u64)(mmcaddr + MMC_RX_UDP_GD) );
	mmc->mmc_rx_udp_err += getreg32( (u64)(mmcaddr + MMC_RX_UDP_ERR) );
	mmc->mmc_rx_tcp_gd += getreg32( (u64)(mmcaddr + MMC_RX_TCP_GD) );
	mmc->mmc_rx_tcp_err += getreg32( (u64)(mmcaddr + MMC_RX_TCP_ERR) );
	mmc->mmc_rx_icmp_gd += getreg32( (u64)(mmcaddr + MMC_RX_ICMP_GD) );
	mmc->mmc_rx_icmp_err += getreg32( (u64)(mmcaddr + MMC_RX_ICMP_ERR) );

	mmc->mmc_rx_udp_gd_octets += getreg32( (u64)(mmcaddr + MMC_RX_UDP_GD_OCTETS) );
	mmc->mmc_rx_udp_err_octets += getreg32( (u64)(mmcaddr + MMC_RX_UDP_ERR_OCTETS) );
	mmc->mmc_rx_tcp_gd_octets += getreg32( (u64)(mmcaddr + MMC_RX_TCP_GD_OCTETS) );
	mmc->mmc_rx_tcp_err_octets += getreg32( (u64)(mmcaddr + MMC_RX_TCP_ERR_OCTETS) );
	mmc->mmc_rx_icmp_gd_octets += getreg32( (u64)(mmcaddr + MMC_RX_ICMP_GD_OCTETS) );
	mmc->mmc_rx_icmp_err_octets += getreg32( (u64)(mmcaddr + MMC_RX_ICMP_ERR_OCTETS) );
	mmc->mmc_tx_fpe_fragment_cntr += getreg32((u64)(mmcaddr + MMC_TX_FPE_FRAG));
	mmc->mmc_tx_hold_req_cntr += getreg32((u64)(mmcaddr + MMC_TX_HOLD_REQ));
	mmc->mmc_rx_packet_assembly_err_cntr +=
		getreg32((u64)(mmcaddr + MMC_RX_PKT_ASSEMBLY_ERR));
	mmc->mmc_rx_packet_smd_err_cntr += getreg32((u64)(mmcaddr + MMC_RX_PKT_SMD_ERR));
	mmc->mmc_rx_packet_assembly_ok_cntr +=
		getreg32((u64)(mmcaddr + MMC_RX_PKT_ASSEMBLY_OK));
	mmc->mmc_rx_fpe_fragment_cntr += getreg32((u64)(mmcaddr + MMC_RX_FPE_FRAG));
}
...
{
	putreg32(0x0, (u64)(mmcaddr + MMC_RX_INTR_MASK));
	putreg32(0x0, (u64)(mmcaddr + MMC_TX_INTR_MASK));
	putreg32(MMC_DEFAULT_MASK, (u64)(mmcaddr + MMC_XGMAC_RX_IPC_INTR_MASK));
}
...
static void dwxgmac_read_mmc_reg(void __iomem *addr, u32 reg, u32 *dest)
{
	...
	tmp += getreg32((u64)(addr + reg));
	tmp += ((u64 )getreg32((u64)(addr + reg + 0x4))) << 32;
	if (tmp > GENMASK(31, 0))
		*dest = ~0x0;
	else
		*dest = *dest + tmp;
...
static void dwxgmac_mmc_read(void __iomem *mmcaddr, struct stmmac_counters *mmc)
{
	...
	dwxgmac_read_mmc_reg(mmcaddr, MMC_XGMAC_RX_CRC_ERR,
			     &mmc->mmc_rx_crc_error);
	mmc->mmc_rx_run_error += getreg32((u64)(mmcaddr + MMC_XGMAC_RX_RUNT_ERR));
	mmc->mmc_rx_jabber_error += getreg32((u64)(mmcaddr + MMC_XGMAC_RX_JABBER_ERR));
	mmc->mmc_rx_undersize_g += getreg32((u64)(mmcaddr + MMC_XGMAC_RX_UNDER));
	mmc->mmc_rx_oversize_g += getreg32((u64)(mmcaddr + MMC_XGMAC_RX_OVER));
	...
	mmc->mmc_rx_watchdog_error += getreg32((u64)(mmcaddr + MMC_XGMAC_RX_WATCHDOG_ERR));

	mmc->mmc_tx_fpe_fragment_cntr += getreg32((u64)(mmcaddr + MMC_XGMAC_TX_FPE_FRAG));
	mmc->mmc_tx_hold_req_cntr += getreg32((u64)(mmcaddr + MMC_XGMAC_TX_HOLD_REQ));
	mmc->mmc_rx_packet_assembly_err_cntr +=
		getreg32((u64)(mmcaddr + MMC_XGMAC_RX_PKT_ASSEMBLY_ERR));
	mmc->mmc_rx_packet_smd_err_cntr +=
		getreg32((u64)(mmcaddr + MMC_XGMAC_RX_PKT_SMD_ERR));
	mmc->mmc_rx_packet_assembly_ok_cntr +=
		getreg32((u64)(mmcaddr + MMC_XGMAC_RX_PKT_ASSEMBLY_OK));
	mmc->mmc_rx_fpe_fragment_cntr +=
		getreg32((u64)(mmcaddr + MMC_XGMAC_RX_FPE_FRAG));
}
