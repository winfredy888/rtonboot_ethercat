			 ...
			 struct net_driver_s *dev)
{
	...
	u32 value = getreg32( (u64)(ioaddr + GMAC_CONTROL) );
	...
	putreg32(value, (u64)(ioaddr + GMAC_CONTROL));
	...
	putreg32(value, (u64)(ioaddr + GMAC_INT_MASK));

#ifdef STMMAC_VLAN_TAG_USED
	/* Tag detection without filtering */
	putreg32(0x0, (u64)(ioaddr + GMAC_VLAN_TAG));
#endif
}
...
static int dwmac1000_rx_ipc_enable(struct mac_device_info *hw)
{
	...
	value = getreg32((u64)(ioaddr + GMAC_CONTROL));
				 ...
				 int mcbitslog2)
{
	...
	switch (mcbitslog2) {
	case 6:
		putreg32(mcfilterbits[0], (u64)(ioaddr + GMAC_HASH_LOW));
		putreg32(mcfilterbits[1], (u64)(ioaddr + GMAC_HASH_HIGH));
		return;
		break;
	case 7:
		numhashregs = 4;
	...
	for (regs = 0; regs < numhashregs; regs++)
		putreg32(mcfilterbits[regs],
		       (u64)(ioaddr + GMAC_EXTHASH_BASE + regs * 4));
}
				 ...
				 struct net_driver_s *dev)
{
	...
	} else if (dev->d_flags & IFF_ALLMULTI) {
...
#endif
	putreg32(value, (u64)(ioaddr + GMAC_FRAME_FILTER));
}
				...
				u32 tx_cnt)
{
	...
	putreg32(flow, (u64)(ioaddr + GMAC_FLOW_CTRL));
}
...
static void dwmac1000_rgsmii(void __iomem *ioaddr, struct stmmac_extra_stats *x)
{
	...
	status = getreg32((u64)(ioaddr + GMAC_RGSMIIIS));
	x->irq_rgmii_n++;
				...
				struct stmmac_extra_stats *x)
{
	...
	u32 intr_mask = getreg32( (u64)(ioaddr + GMAC_INT_MASK));
	int ret = 0;
	...
	if (intr_status & GMAC_INT_STATUS_LPIIS) {
		...
		ret = getreg32((u64)(ioaddr + LPI_CTRL_STATUS));
				   ...
				   bool en_tx_lpi_clockgating)
{
	 ...
	 * state.
	 */
	value = getreg32((u64)(ioaddr + LPI_CTRL_STATUS));
	value |= LPI_CTRL_STATUS_LPIEN | LPI_CTRL_STATUS_LPITXA;
	putreg32(value, (u64)(ioaddr + LPI_CTRL_STATUS));
}
...
static void dwmac1000_set_eee_timer(struct mac_device_info *hw, int ls, int tw)
{
	 ...
	 */
	putreg32(value, (u64)(ioaddr + LPI_TIMER_CTRL));
}
...
{
	u32 value = getreg32((u64)(ioaddr + GMAC_DEBUG));
...
int dwmac1000_setup(struct stmmac_priv *priv)
{
	...
	netdev_info(priv->dev, "\tDWMAC1000\n");
