...
struct stmmac_ops {
	...
	void (*core_init)(struct mac_device_info *hw, struct net_driver_s * dev);
	...
	void (*set_filter)(struct mac_device_info *hw, struct net_driver_s * dev);
	...
	int (*safety_feat_irq_status)(struct net_driver_s * ndev,
	...
	int (*add_hw_vlan_rx_fltr)(struct net_driver_s * dev,
				   struct mac_device_info *hw,
				   u16 proto, u16 vid);
	int (*del_hw_vlan_rx_fltr)(struct net_driver_s * dev,
				   struct mac_device_info *hw,
				   u16 proto, u16 vid);
	void (*restore_hw_vlan_rx_fltr)(struct net_driver_s * dev,
					struct mac_device_info *hw);
	/* TX Timestamp */
