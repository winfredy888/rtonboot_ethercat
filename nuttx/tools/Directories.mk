...
ifeq ($(CONFIG_LIBETHERCAT),y)
KERNDEPDIRS += libs$(DELIM)libethercat
else
CLEANDIRS += libs$(DELIM)libethercat
endif

ifeq ($(CONFIG_LIBSOEM),y)
KERNDEPDIRS += libs$(DELIM)libsoem
else
CLEANDIRS += libs$(DELIM)libsoem
endif
