...
libs$(DELIM)libethercat$(DELIM)libethercat$(LIBEXT): pass2dep
	$(Q) $(MAKE) -C libs$(DELIM)libethercat libethercat$(LIBEXT) EXTRAFLAGS="$(EXTRAFLAGS)"	
	
staging$(DELIM)libethercat$(LIBEXT): libs$(DELIM)libethercat$(DELIM)libethercat$(LIBEXT)
	$(Q) $(call INSTALL_LIB,$<,$@)	
	
libs$(DELIM)libsoem$(DELIM)libsoem$(LIBEXT): pass2dep
	$(Q) $(MAKE) -C libs$(DELIM)libsoem libsoem$(LIBEXT) EXTRAFLAGS="$(EXTRAFLAGS)"	
	
staging$(DELIM)libsoem$(LIBEXT): libs$(DELIM)libsoem$(DELIM)libsoem$(LIBEXT)
	$(Q) $(call INSTALL_LIB,$<,$@)		
