...
/* UART4 is console and ttys0, follows U-Boot Bootloader */
...
static struct a64_uart_port_s g_uart4priv =
{
  ...
  .config =
    {
      .uart       = RK3568_UART4_ADDR
    },

    .irq_num      = RK3568_UART4_IRQ,
    .is_console   = 1
};

/* UART4 I/O Buffers */

static char g_uart4rxbuffer[CONFIG_UART0_RXBUFSIZE];
static char g_uart4txbuffer[CONFIG_UART0_TXBUFSIZE];
